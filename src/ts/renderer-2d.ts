...
export const Renderer2D = {
   ...
   */
  create: function(engine: Matter.Engine, canvas: HTMLCanvasElement): Matter.Render {
    try {
   ...
   */
  start: function(render: Matter.Render): void {
   ...
   * @param {Matter.Render} render - The Matter.js renderer
   */
  stop: function(render: Matter.Render | null): void {
    if (render) {

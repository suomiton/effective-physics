...
declare namespace Matter {
  ...
  namespace Bodies {
    function rectangle(x: number, y: number, width: number, height: number, options?: any): Body;
  ...
  namespace Vector {
    function sub(vectorA: { x: number; y: number }, vectorB: { x: number; y: number }): { x: number; y: number };
  }

  namespace World {
    function add(world: World, body: Body | Body[] | Constraint | Constraint[]): void;
    function remove(world: World, body: Body | Constraint, deep?: boolean): void;
  }
}
...
declare namespace THREE {
  ...
  class MeshBasicMaterial extends Material {
    constructor(options?: { color?: Color | string | number; wireframe?: boolean });
  }
  ...
  class ExtrudeGeometry extends BufferGeometry {
    constructor(shape: Shape, options?: { depth?: number; bevelEnabled?: boolean });
  }
